...
class GeminiGUI(QWidget):
    ...
    def export_tabs(self, mode):
        ...
        filepath, _ = QFileDialog.getSaveFileName(self, "Export Tabs", os.path.join(CHAT_DIR, default_name), "JSON Files (*.json)")
        if filepath:
            try:
    ...
    def import_tabs(self):
        filepath, _ = QFileDialog.getOpenFileName(self, "Import Tabs", CHAT_DIR, "JSON Files (*.json)")
        if not filepath:
            return
    ...
    def setup_settings_dialog(self):
        ...
        self.settings_dialog.resize(340, 260)
